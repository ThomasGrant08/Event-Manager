...
namespace PlanAhead.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,lat,lng,eventTime,Line1,Line2,Line3,Line4,Postcode")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,lat,lng,eventTime,Line1,Line2,Line3,Line4,Postcode")] Event @event)
        {
            if (id != @event.Id)
            {
                return NotFound();
